...
Gohan DAO は、まったり個人/共同開発しているコミュニティです。
個人開発してるプロダクトを共有して一緒に改善したり、技術まわりの検証など行っていけたらと考えています。
※DAO 化してみたいが DAO ではない

Discord にぜひご参加ください！
https://discord.gg/C8h6PpMTmg
週 1 ペースで MTG しています。興味本位でお気軽にどうぞ！
※エンジニアでない方も歓迎です。

現在開発中のアプリ: https://nftotaku.xyz/  
github レポジトリ: https://github.com/gohandao
